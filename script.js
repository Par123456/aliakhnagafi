document.addEventListener('DOMContentLoaded', () => {
    ...
    let newsData = JSON.parse(localStorage.getItem('newsData')) || [
        ...
        { id: 'news4', title: 'کارگاه خلاقیت و نوآوری', date: '۱۴۰۲/۰۷/۱۰', image: 'https://picsum.photos/id/203/400/250', description: 'کارگاهی دو روزه با محوریت خلاقیت و ایده‌پر��ازی برای دانش‌آموزان برگزار شد.' },
